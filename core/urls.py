...
urlpatterns = [
    ...
    path("shopping-list.csv", views.shopping_list_csv, name="shopping_list_csv"),
    path("shopping-list.txt", views.shopping_list_txt, name="shopping_list_txt"),
    path("settings/", views.SettingsView.as_view(), name="settings"),
    path("roster/", views.RosterView.as_view(), name="roster"),
    path("bench/<str:username>/", views.PublicBenchView.as_view(), name="bench_public"),
